...
public class ShadowLayout extends RelativeLayout {
    ...
    private boolean mIsShadowedNoneTop;
    private boolean mIsShadowedNoneBottom;
    ...
    public ShadowLayout(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        try {
            ...
            setIsShadowedNoneTop(typedArray.getBoolean(R.styleable.ShadowLayout_sl_shadowed_none_top, false));
            setIsShadowedNoneBottom (typedArray.getBoolean(R.styleable.ShadowLayout_sl_shadowed_none_bottom, false));
    ...
    public void setIsShadowedNoneTop(final boolean isShadowed) {
        mIsShadowedNoneTop = isShadowed;
        postInvalidate();
    }

    public void setIsShadowedNoneBottom(final boolean isShadowed) {
        mIsShadowedNoneBottom = isShadowed;
        postInvalidate();
    }
    ...
    public void resetShadow() {
        ...
        int paddingTop = mIsShadowedNoneTop ? 0 : padding;
        int paddingBottom = mIsShadowedNoneBottom ? 0 : padding;
